	...
	foreach($types as $keyType => $valueType)
	{
		...
		switch($valueType):
							...
							$content .= '<span class="minithumb-own3d" style="opacity:1">';
								...
								$content .= '<span class="minithumb-own3d-info" style="color:'.$livetv_span_color.'">';
									...
									$content .= '<span class="w-view">';
										...
										//Button large
										$content .=' <a class="bubble button" href="'.esc_url('' . $livetv_current_url . 'liveview='.$channelKey.'&mode=full&type=own3d', array('http', 'https')).'" title="'. __('Swtich to Large view', 'livetv').'">'.__('Large', 'livetv').'</a>';
										//End button large
									...
									//Live since
									$content .= '<span class="w-live">'.__('Live!', 'livetv').' ' . date('d-m-Y H:i', $live_until) . '</span>';
									//End live since
						...
						if($livetv_view_offline == 'on' && $live_now == 'false' || $livetv_view_offline == 'widget_off' && $live_now == 'false')
						{
							...
							$content .= '<span class="minithumb-own3d offline">';
								...
								$content .= '<span class="minithumb-own3d-info" style="color:'.$livetv_span_color.'">';
									...
									//Live since
									$content .= '<span class="w-off-live">'.__('Live: Offline', 'livetv').'</span>';
									//End live since
			...
			case 'twitch': //Twitch thumbnails loop
					...
					$base_url = preg_replace(array('#%20#', '#,$#'), array('', ''), $base_url);
					$json_file = file_get_contents($base_url);
							...
							$content .= '<span class="minithumb-twitch" style="opacity:1">';
								...
								$content .= '<span class="minithumb-twitch-info" style="color:'.$livetv_span_color.'">';
									...
									$content .= '<span class="w-view">';
										...
										//Button large
										$content .=' <a class="bubble button" href="'.esc_url('' . $livetv_current_url . 'liveview='.$live_name.'&mode=full&type=twitch', array('http', 'https')).'" title="'. __('Swtich to Large view', 'livetv').'">'.__('Large', 'livetv').'</a>';
										//End button large
							...
							$content .= '<span class="minithumb-justin" style="opacity:1">';
								...
								$content .= '<span class="minithumb-justin-info" style="color:'.$livetv_span_color.'">';
									...
									$content .= '<span class="w-view">';
										...
										//Button large
										$content .=' <a class="bubble button" href="'.esc_url('' . $livetv_current_url . 'liveview='.$live_name.'&mode=full&type=justin', array('http', 'https')).'" title="'. __('Swtich to Large view', 'livetv').'">'.__('Large', 'livetv').'</a>';
										//End button large
